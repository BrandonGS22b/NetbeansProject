...
/////////////////////////////////////////////////////////////////////////////////
        ...
        NewClass.PILA resultadoPila = new NewClass.PILA();
...
////     
 ...
 while (!a.Esta_Vacia()) {
        System.out.println("El dato desapilado es " + a.DesApilar());
    }
...
/////////////////////////////////////////////////////////////////////////
        ...
        public int Tope() {//Es el mismo StackTop visto en clase
            if (Items.isEmpty()) {//si la lista Items está vacía"
                return Items.get(Items.size()-1);//utiliza para devolver el elemento superior de una estructura de datos tipo pila o stack.
            } else {
                System.out.println("La pila se encuentra vacia");
                return -1;
            }
